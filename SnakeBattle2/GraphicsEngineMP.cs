...
{
    public class GraphicsEngineMP
    {
        private Board board;
        private MPGame _game;
        private float boardPixelWidth;
        private float boardPixelHeight;
        private int boardXOffset;
        private int boardYOffset;

        public GraphicsEngineMP(Board board)
        {
            this.Initialize(board, 0, 0);
        }

        public GraphicsEngineMP(Board board, int xOffset, int yOffset, MPGame game)
        {
            _game = game;
